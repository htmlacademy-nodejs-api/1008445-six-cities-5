...
import type { Offer, Comment, PreviewOffer, NewOrEditOffer } from '../../types/types';
...
export const getOffers = ({ [StoreSlice.SiteData]: SITE_DATA}: State): PreviewOffer[] => SITE_DATA.offers;

export const getIsFavoriteOffersLoading = ({ [StoreSlice.SiteData]: SITE_DATA }: State): boolean => SITE_DATA.isFavoriteOffersLoading;
export const getFavoriteOffers = ({ [StoreSlice.SiteData]: SITE_DATA}: State): PreviewOffer[] => SITE_DATA.favoriteOffers;

export const getIsOfferLoading = ({ [StoreSlice.SiteData]: SITE_DATA }: State): boolean => SITE_DATA.isOfferLoading;
export const getOffer = ({ [StoreSlice.SiteData]: SITE_DATA }: State): Offer | NewOrEditOffer | null => SITE_DATA.offer;

export const getPremiumOffers = ({ [StoreSlice.SiteData]: SITE_DATA }: State): PreviewOffer[] => SITE_DATA.premiumOffers;
